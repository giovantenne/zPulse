...
public class ZPulse extends MIDlet implements CommandListener
{
	...
	public void startApp()
	{
		...
		display = Display.getDisplay(this);
	    	cmExit = new Command("Exit", Command.EXIT, 5);
	    	cmBack1 = new Command("Back", Command.BACK, 5);
	    	cmPulse = new Command("Pulse", Command.SCREEN, 1);     
	    	cmZBeep = new Command("Click", Command.SCREEN, 3);     
	    	cmZPulse = new Command("Tap", Command.SCREEN, 4);     
	    	cmInfo = new Command("Info", Command.SCREEN, 1);     
